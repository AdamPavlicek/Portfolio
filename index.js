...
function project1() {
  return `
    <div class='project' name="project1">
...
function project2() {
  return `
    <div class='project' name="project2">
      <h2>SquadUp!</h2>
  ...
  return `
    <div class='js-containe container'>
      <div class='project-buttons'>
        <button class='js-project1 project-button'>Project1</button>
        <button class='js-project2 project-button'>SquadUp!</button>
      </div>
...
function handleProject1() {
  $('main').on('click', '.js-project1', function (event) {
    event.preventDefault();
    $('.project').remove();
    $('.portfolio-container').append(project1());
  });
}
function handleProject2() {
  $('main').on('click', '.js-project2', function (event) {
    event.preventDefault();
    $('.project').remove();
    $('.portfolio-container').append(project2());
  });
}
